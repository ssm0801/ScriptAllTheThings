...
- Script is used to add/multiply/divide/subtract multiple numbers in a single command line.
...
if len(sys.argv) < 4:
    print("Usage: quick_math_calculator.py <add|mul|div|sub|avg> <num01> <num02> [num03..num99]")
    exit(1)
